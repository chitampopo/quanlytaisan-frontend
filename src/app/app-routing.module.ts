...
const routes: Routes = [
  ...
  { path: 'bat-dong-san-quan-ly', component: QuanLyBdsComponent },
  { path: 'bat-dong-san-sap-xep', component: SapXepBatDongSanComponent },
  ...
  { path: 'cai-dat', component: CaiDatComponent},
